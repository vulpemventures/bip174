...
const dummyPubkey = () => Buffer.from('03b1341ccba7683b6af4f1238cd6e97e7167d569fac47f1e48d47541844355bd46', 'hex');
const dummyXpub = () => Buffer.from('0488b21e034a346d9880000000032e6467810075260ee7a831189d814e656a300ab7f9a' +
    '151b7377efffe91051103b034ec32baa6c3c05481a9d15c6ee6c48a9692e18285c174d4' +
    '14718f85670e22', 'hex');
const dummySig = () => Buffer.from('304302200424b58effaaa694e1559ea5c93bbfd4a89064224055cdf070b6' +
    '771469442d07021f5c8eb0fea6516d60b8acb33ad64ede60e8785bfb3aa9' +
    '4b99bdf86151db9a9a01', 'hex');
...
exports.fixtures = {
    valid: [
        {
            ...
            expected: 'cHNidP8BAFMBAAAAAdSnb/ld4fTAFho+U+qHapHtlTMa6NAS2B+XE4SYzl2GAwAAAAD/' +
        ...
        },
        {
            ...
            expected: 'cHNidP8BAFMBAAAAAdSnb/ld4fTAFho+U+qHapHtlTMa6NAS2B+XE4SYzl2G' +
        ...
        },
        {
            ...
            args: [
                {
                    hash: '0102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f00',
                    index: 1,
                },
            ],
            expected: 'cHNidP8BAHwBAAAAAtSnb/ld4fTAFho+U+qHapHtlTMa6NAS2B+XE4SYzl2GAwAAAAD/' +
        ...
        },
        {
            ...
            args: [
                {
                    script: Buffer.from('0102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f00', 'hex'),
                    value: 3,
                },
            ],
            expected: 'cHNidP8BAHwBAAAAAdSnb/ld4fTAFho+U+qHapHtlTMa6NAS2B+XE4SYzl2GAwAAAAD/' +
    ...
    invalid: [
        ...
        },
        {
            ...
            exception: 'Data for global key globalXpub is incorrect: Expected { ' +
        ...
        },
        {
            ...
            exception: 'Data for input key nonWitnessUtxo is incorrect: Expected Buffer and got',
        },
        {
            method: 'updateInput',
            addInputOutput: true,
        ...
        },
        {
            ...
            exception: 'Data for input key witnessUtxo is incorrect: Expected { ' +
        ...
        },
        {
            ...
            exception: 'Data for input key partialSig is incorrect: Expected { pubkey: ' +
        ...
        },
        {
            ...
            exception: 'Data for input key sighashType is incorrect: Expected number and got',
        },
        {
            method: 'updateInput',
            addInputOutput: true,
            args: [0, { redeemScript: 'a' }],
            exception: 'Data for input key redeemScript is incorrect: Expected Buffer and got',
        },
        {
            method: 'updateInput',
            addInputOutput: true,
            args: [0, { witnessScript: 'a' }],
            exception: 'Data for input key witnessScript is incorrect: Expected Buffer and got',
        },
        {
            method: 'updateInput',
            addInputOutput: true,
            ...
            exception: 'Data for input key bip32Derivation is incorrect: Expected { ' +
        ...
        },
        {
            ...
            exception: 'Data for input key finalScriptSig is incorrect: Expected Buffer and got',
        },
        {
            method: 'updateInput',
            addInputOutput: true,
            args: [0, { finalScriptWitness: 8 }],
            exception: 'Data for input key finalScriptWitness is incorrect: Expected Buffer and got',
        },
        {
            method: 'updateInput',
            addInputOutput: true,
            args: [0, { porCommitment: 8 }],
            exception: 'Data for input key porCommitment is incorrect: Expected string and got',
        },
        {
            method: 'updateOutput',
            addInputOutput: true,
            args: [0, { redeemScript: 8 }],
            exception: 'Data for output key redeemScript is incorrect: Expected Buffer and got',
        },
        {
            method: 'updateOutput',
            addInputOutput: true,
            args: [0, { witnessScript: 8 }],
            exception: 'Data for output key witnessScript is incorrect: Expected Buffer and got',
        },
        {
            method: 'updateOutput',
            addInputOutput: true,
            ...
            exception: 'Data for output key bip32Derivation is incorrect: Expected { ' +
                'masterFingerprint: Buffer; pubkey: Buffer; path: string; } and got',
        },
        {
            method: 'updateInput',
        ...
        },
        {
            ...
            exception: 'Use the method for your specific key instead of addUnknownKeyVal*',
        },
        {
            method: 'addUnknownKeyValToGlobal',
            addInputOutput: true,
