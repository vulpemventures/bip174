...
exports.fixtures = [
    {
        description: 'Step 1: From 2 empty inputs and 2 empty outputs, add set of info.',
        before: 'cHNidP8BAJoCAAAAAljoeiG1ba8MI76OcHBFbDNvfLqlyHV5JPVFiHuyq911AAAAAAD///' +
        ...
        inputData: [
            {
                nonWitnessUtxo: b('0200000001aad73931018bd25f84ae400b68848be09db706eac2ac18298babee71' +
                ...
                redeemScript: b('5221029583bf39ae0a609747ad199addd634fa6108559d6c5cd39b4c2183f1ab96' +
                    'e07f2102dab61ff49a14db6a7d02b0cd1fbb78fc4b18312b5b4e54dae4dba2fbfe' +
                    'f536d752ae'),
                bip32Derivation: [
                    {
                        masterFingerprint: b('d90c6a4f'),
                        pubkey: b('029583bf39ae0a609747ad199addd634fa6108559d6c5cd39b4c2183f1ab96e07f'),
                        path: "m/0'/0'/0'",
                    },
                    {
                        masterFingerprint: b('d90c6a4f'),
                        pubkey: b('02dab61ff49a14db6a7d02b0cd1fbb78fc4b18312b5b4e54dae4dba2fbfef536d7'),
                        path: "m/0'/0'/1'",
                    },
                ],
            },
            {
                witnessUtxo: {
                    ...
                    asset: b('5ac9f65c0efcc4775e0baec4ec03abdde22473cd3cf33c0419ca290e0751b225'),
                    nonce: b('00'),
                },
                redeemScript: b('00208c2353173743b595dfb4a07b72ba8e42e3797da74e87fe7d9d7497e3b2028903'),
                witnessScript: b('522103089dc10c7ac6db54f91329af617333db388cead0c231f723379d1b99030b' +
                    '02dc21023add904f3d6dcf59ddb906b0dee23529b7ffb9ed50e5e8615192686022' +
                    '1f0e7352ae'),
                bip32Derivation: [
                    {
                        masterFingerprint: b('d90c6a4f'),
                        pubkey: b('023add904f3d6dcf59ddb906b0dee23529b7ffb9ed50e5e86151926860221f0e73'),
                        path: "m/0'/0'/3'",
                    },
                    {
                        masterFingerprint: b('d90c6a4f'),
                        pubkey: b('03089dc10c7ac6db54f91329af617333db388cead0c231f723379d1b99030b02dc'),
                        path: "m/0'/0'/2'",
                    },
                ],
            },
        ...
        outputData: [
            {
                bip32Derivation: [
                    {
                        masterFingerprint: b('d90c6a4f'),
                        pubkey: b('03a9a4c37f5996d3aa25dbac6b570af0650394492942460b354753ed9eeca58771'),
                        path: "m/0'/0'/4'",
                    },
                ],
            },
            {
                bip32Derivation: [
                    {
                        masterFingerprint: b('d90c6a4f'),
                        pubkey: b('027f6399757d2eff55a136ad02c684b1838b6556e5f1b6b34282a94b6b50051096'),
                        path: "m/0'/0'/5'",
                    },
                ],
            },
        ],
        after: 'cHNidP8BAJoCAAAAAljoeiG1ba8MI76OcHBFbDNvfLqlyHV5JPVFiHuyq911AAAAAAD///' +
            '//g40EJ9DsZQpoqka7CwmK6kQiwHGyyng1Kgd5WdB86h0BAAAAAP////8CcKrwCAAAAAAW' +
            'ABTYXCtx0AYLCcmIauuBXlCZHdoSTQDh9QUAAAAAFgAUAK6pouXw+HaliN9VRuh0LR2HAI' +
        ...
        inputData: [
            {
                partialSig: [
                    {
                        pubkey: b('029583bf39ae0a609747ad199addd634fa6108559d6c5cd39b4c2183f1ab96e07f'),
                        signature: b('3044022074018ad4180097b873323c0015720b3684cc8123891048e7dbcd9b' +
            ...
            },
            {
                partialSig: [
                    {
                        pubkey: b('03089dc10c7ac6db54f91329af617333db388cead0c231f723379d1b99030b02dc'),
                        signature: b('3044022062eb7a556107a7c73f45ac4ab5a1dddf6f7075fb1275969a7f383e' +
    ...
    {
        description: 'Step 4: Adds separate partialSigs to both inputs (second signers)',
        before: 'cHNidP8BAJoCAAAAAljoeiG1ba8MI76OcHBFbDNvfLqlyHV5JPVFiHuyq911AAAAAAD///' +
            '//g40EJ9DsZQpoqka7CwmK6kQiwHGyyng1Kgd5WdB86h0BAAAAAP////8CcKrwCAAAAAAW' +
            'ABTYXCtx0AYLCcmIauuBXlCZHdoSTQDh9QUAAAAAFgAUAK6pouXw+HaliN9VRuh0LR2HAI' +
            '8AAAAAAAEAuwIAAAABqtc5MQGL0l+ErkALaISL4J23BurCrBgpi6vucatlb4sAAAAASEcw' +
        ...
        inputData: [
            {
                partialSig: [
                    {
                        pubkey: b('02dab61ff49a14db6a7d02b0cd1fbb78fc4b18312b5b4e54dae4dba2fbfef536d7'),
                        signature: b('3045022100f61038b308dc1da865a34852746f015772934208c6d24454393c' +
            ...
            },
            {
                partialSig: [
                    {
                        pubkey: b('023add904f3d6dcf59ddb906b0dee23529b7ffb9ed50e5e86151926860221f0e73'),
                        signature: b('3044022065f45ba5998b59a27ffe1a7bed016af1f1f90d54b3aa8f7450aa5f' +
    ...
    },
    {
        ...
        inputData: [
            {
                finalScriptSig: b('00473044022074018ad4180097b873323c0015720b3684cc8123891048e7dbcd9b' +
            ...
            {
                finalScriptSig: b('2200208c2353173743b595dfb4a07b72ba8e42e3797da74e87fe7d9d7497e3b2028903'),
                finalScriptWitness: b('0400473044022062eb7a556107a7c73f45ac4ab5a1dddf6f7075fb1275969a7f38' +
