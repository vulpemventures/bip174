...
exports.fixtures = [
    ...
    },
    {
        ...
        exception: 'Decode Error: globalXpub has invalid extended pubkey in key 0x01',
    },
    {
        data: {
            globalMapKeyVals: [
                ...
                {
                    key: b('010488b21e034a346d9880000000032e6467810075260ee7a831189d814e656a' +
        ...
        exception: 'Decode Error: Global GLOBAL_XPUB value length should be multiple of 4',
    },
    {
        data: {
            globalMapKeyVals: [
            ...
            inputKeyVals: [
                [
                    {
                        key: b('01'),
                        value: b('70aaf00800000000160014d85c2b71d0060b09c9886aeb815e50991dda124d'),
                    },
                    {
                        key: b('00'),
                        value: b('03'),
    ...
    },
    {
        ...
        expected: 'cHNidP8BAAoCAAAAAAAAAAAATwEEiLIeA0o0bZiAAAAAAy5kZ4EAdSYO56gxGJ2BTmVqM' +
